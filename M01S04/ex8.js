...
/* var cidadesPopulosas = []; */
/* cidades.forEach((_,index)=>{
    if (cidades[index].populacao > 200000){
        cidadesPopulosas.push(cidades[index]);
    }
}); */


const cidadePopulosa = cidades.filter((cidade) => {
  return cidade.populacao > 200000;
});

console.log(cidadePopulosa);
